  ...
  <nav class="nav" style="z-index: 999; background-color: #000;    width: 100%;  height: 75px;  position: fixed;  line-height: 65px;  text-align: center; padding-top: 12px;">
    ...
    <div class="container">
      ...
      <a href="../HTML/Adm1.php">
        <button type="button-cadastrar" class="btn btn-outline-light btn-lg" data-toggle="modal" style="margin-right: 10px; font-size: 15px;" data-target="#Login">Administração</button>
      </a>
